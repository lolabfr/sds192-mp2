...
graph <- function(yElement, fillElement, yAxisLab) {
  ggplot(houseCandContrib, aes(x = cand_name, y = yElement, fill = fillElement)) + 
...
candVs.Money <- graph(houseCandContrib$totalContributionCandidate,
...
```{r, message=FALSE, warning=FALSE}
candVs.Vote <- graph(houseCandContrib$general_votes, houseCandContrib$ge_winner, "General Votes\n(Hundreds of Millions)") +
